...
import com.example.sqlite.database.Codes;
...
public class MainActivity extends AppCompatActivity {
    ...
    //region main menu -> top right corner on actionbar
    @Override
    ...
    //region Context menu ->long click on list item
    @Override
    ...
    //clear button action, clears the edittext fields
